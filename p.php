...
if (isset($_GET['id'])) {
    ...
    $content = file_get_contents("https://api.search.nicovideo.jp/api/v2/snapshot/video/contents/search?q=${query}&targets=${targets}&fields=thumbnailUrl,contentId,title,viewCounter,description&_sort=-mylistCounter&_offset=0&_limit=50");
